...
public class VanMaxLevel : Mod
{
    ...
    public override string Name => "MaxLevel 97";
    public override string Description => "Increase the level limit to 97";
